...
### 2.2 Identificación de datos atípicos y tratamiento de los mismos
...
explicación de la variabilidad de los datos. Estos hallazgos ayudan a
identificar las dimensiones principales en los datos y permiten una
reducción de la dimensionalidad al representar los datos en un espacio
de menor dimensión definido por los componentes principales.
...
-   El análisis de la Matriz de correlaciones reveló relaciones
    ...
    Views y Likes, así como entre Likes y Views. Las variables Comments
    y Stream también mostraron correlaciones moderadas con Views y
    Likes. Estas correlaciones resaltan la importancia de estas
    variables en el análisis de los datos y proporcionan información
    valiosa para comprender las relaciones entre las características y
...
-   La exploración del Modelo PCA señaló que las variables Danceability,
    ...
    dimensionalidad por los componentes principales.
